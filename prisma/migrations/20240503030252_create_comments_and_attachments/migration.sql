...
-- AddForeignKey
ALTER TABLE "comments" ADD CONSTRAINT "comments_answer_fkey" FOREIGN KEY ("answer") REFERENCES "answers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "attachments" ADD CONSTRAINT "attachments_answer_fkey" FOREIGN KEY ("answer") REFERENCES "answers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
